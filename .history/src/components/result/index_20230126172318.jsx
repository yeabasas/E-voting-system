...
const Result = () => {
  ...
  return(
    ...
    <div className="w-2/3 grid grid-cols-2 items-center justify-around gap-7">
      {features.map((feature, idx) => (
          <div className="w-fit h-fit flex flex-col items-center gap-2 rounded-md shadow-2xl pb-2 cursor-pointer"
          >
            <img
