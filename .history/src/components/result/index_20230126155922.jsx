...
const Result = () => {
  ...
  return(
    ...
    <div className="grid grid-cols-5 items-center justify-around gap-7">
      {features.map((feature, idx) => (
          ...
          >
            ...
            <div className="text-lg font-semibold">votes: {feature.voted}</div>
            <div className="text-lg font-semibold">votes: {feature.party}</div>
