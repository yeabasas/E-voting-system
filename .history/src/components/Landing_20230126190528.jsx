...
const Landing = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center py-10">
      ...
      <div>The decision to register to vote is yours. If you decide to register to vote, the office at which you are submitting this application will remain confidential and will be used only for voter registration purposes. If you decline to register to vote, your decision will remain confidential and will be used only for voter registration purposes.</div>
    </div>
  );
};
